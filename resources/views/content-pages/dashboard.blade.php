...
@section('sidebar')
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="departmentDropdown">
            <li>
                <a class="dropdown-item" href="department">BSE</a>
            </li>
            <li>
                <a class="dropdown-item" href="department">BSN</a>
            </li>
        </ul>
    </li>
    <li class="nav-item">
      ...
      <div class="card h-100 card-min-width">
        <div class="card-body d-flex align-items-center px-4 py-2">
          <img
            ...
            class="card-img-icon me-3"
            alt="Icon"
          />
          <div class="flex-grow-1">
            <p class="card-text mb-0 text-end fs-5">Administrators</p>
